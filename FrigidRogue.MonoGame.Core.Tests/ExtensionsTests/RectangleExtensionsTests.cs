...
namespace FrigidRogue.MonoGame.Core.Tests.Extensions
{
    ...
    {
        [DataTestMethod]
        [DataRow(new Point(1, 1))]
        public void Should_Create_Rectangle_Covering_3_Points(Point p)
        {
            // Act
            var result = RectangleExtensions.CoveringPoints() map.RectangleCoveringPoints(new Point(1, 1), new Point(3, 2), new Point(4, 1));
